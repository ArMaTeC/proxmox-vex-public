...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/core/esxi_cluster.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: ESXi Cluster Manager Facade - Layer 5
...
Wraps VMwareManager to look like a cluster manager for migration integration.
So the migration engine treats ESXi like PVE
"""
...
class ESXiClusterManager:
    """Makes an ESXi host look like a ProxmoxVEx cluster for migration.
    ...
    def get_vms(self):
        """list VMs in a format close to what PVE returns"""
