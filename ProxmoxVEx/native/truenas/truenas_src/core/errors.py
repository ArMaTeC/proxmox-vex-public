...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/native/truenas/truenas_src/core/errors.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: Typed exceptions for the TrueNAS JSON-RPC client.
...
Kept in their own module (no Flask/ProxmoxVEx imports) so both ``ws_client``
