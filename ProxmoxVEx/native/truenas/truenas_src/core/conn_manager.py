...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/native/truenas/truenas_src/core/conn_manager.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: One WebSocket connection per configured TrueNAS...
...
Mirrors the "connection manager" pattern used by other ProxmoxVEx plugins
...
log = logging.getLogger("native.truenas.conn_manager")
...
class ConnectionManager:
    ...
    def test_connection(self, instance_cfg, api_key):
        ...
        (same id) and hits "Test connection" -> the cached client for that
        ...
        try:
            ...
            log.error(f"[truenas] unexpected error testing instance '{instance_cfg.get('id')}': {e}", exc_info=True)
