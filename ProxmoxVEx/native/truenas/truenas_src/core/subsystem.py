...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/native/truenas/truenas_src/core/subsystem.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: ``Subsystem`` contract — brief §2's synthesis of the...
...
log = logging.getLogger("native.truenas.subsystem")
...
class ReadOnlySubsystem(Exception):
    ...
    def __init__(self, subsystem_id):
        super().__init__(f"subsystem '{subsystem_id}' has no write support in this phase")
...
class ConfirmationRequired(Exception):
    ...
    def __init__(self, expected, got):
        super().__init__(f"confirmation mismatch: expected {expected!r}, got {got!r}")
