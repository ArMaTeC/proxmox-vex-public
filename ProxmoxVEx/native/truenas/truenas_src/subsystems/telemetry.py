...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/native/truenas/truenas_src/subsystems/telemetry.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: Overview telemetry (CPU/memory/network) — the...
...
def telemetry(conn, physmem=None):
    ...
    if iface_names:
        ...
        specs = [
            (f"reporting.get_data(interface:{name})", (lambda n=name: network_series(conn, n)), [])
