...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/native/truenas/truenas_src/subsystems/data_protection.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: Data protection posture (F6, read-only):...
...
leak a real secret to anyone with ``storage.view`` on the ProxmoxVEx panel,
...
class DataProtectionSubsystem(Subsystem):
    ...
    def list(self, conn):
        ...
        (cloudsync, cloudsync_error), (rsync, rsync_error), (certs, certs_error) = parallel_safe_calls([
        ...
        return {
            "cloudsync": cloudsync,
            "cloudsync_error": cloudsync_error,
            "rsync": rsync,
            "rsync_error": rsync_error,
            "certificates": certs,
            "certificates_error": certs_error,
        }
