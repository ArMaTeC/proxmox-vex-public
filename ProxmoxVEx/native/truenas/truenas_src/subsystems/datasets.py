...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/native/truenas/truenas_src/subsystems/datasets.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: Datasets/zvols subsystem: ``pool.dataset.query`` +...
...
log = logging.getLogger("native.truenas.subsystems.datasets")
...
def quota(conn, dataset_id, quota_type=DEFAULT_QUOTA_TYPE):
    ...
    try:
        ...
        log.warning(f"[truenas] quota lookup failed for dataset {dataset_id!r} (quota_type={quota_type!r}): {e}")
        return []
