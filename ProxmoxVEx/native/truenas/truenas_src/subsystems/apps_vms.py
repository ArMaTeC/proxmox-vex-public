...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/native/truenas/truenas_src/subsystems/apps_vms.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: Apps/VMs subsystem: ``app.query`` (Docker-backed Apps...
...
def build_vm_control_envelope(op, vm_id):
    ...
    try:
        ...
        raise ValueError("vm_id must be an integer") from None
    if op == "start":
