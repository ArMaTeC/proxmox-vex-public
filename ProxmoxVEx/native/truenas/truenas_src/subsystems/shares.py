...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/native/truenas/truenas_src/subsystems/shares.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: Shares subsystem: SMB, NFS and iSCSI...
...
class SharesSubsystem(Subsystem):
    ...
    def list(self, conn):
        ...
        (
            (smb, smb_error),
            (nfs, nfs_error),
            (targets, targets_error),
            (extents, extents_error),
            (targetextents, targetextents_error),
        ) = parallel_safe_calls([
        ...
        return {
            ...
            "nfs": nfs,
            "nfs_error": nfs_error,
            "iscsi_targets": targets,
            "iscsi_targets_error": targets_error,
            "iscsi_extents": extents,
            "iscsi_extents_error": extents_error,
            "iscsi_targetextents": targetextents,
            "iscsi_targetextents_error": targetextents_error,
        }
