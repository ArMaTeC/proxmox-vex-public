...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/native/opnsense/opnsense_src/routes/logs.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: Firewall log endpoint — paginated tail.
...
from opnsense_src.collectors import collect_firewall_log
