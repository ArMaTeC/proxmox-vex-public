...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/native/opnsense/opnsense_src/routes/dhcp_subnet.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: Kea DHCPv4 subnet route — list / create / delete.
...
Mounted on `/api/opnsense/dhcp_subnet`. Sibling to `/api/dhcp`
...
from opnsense_src.writers import AuditLog, DhcpSubnetInput, DhcpSubnetWriter
