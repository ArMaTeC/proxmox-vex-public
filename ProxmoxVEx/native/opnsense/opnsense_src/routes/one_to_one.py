...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/native/opnsense/opnsense_src/routes/one_to_one.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: 1:1 NAT route — list / create / delete BINAT rules.
...
Mounted on `/api/opnsense/one_to_one`. Refuses writes when
...
from opnsense_src.writers import AuditLog, OneToOneNatInput, OneToOneNatWriter
