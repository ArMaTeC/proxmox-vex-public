...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/native/opnsense/opnsense_src/routes/dhcp.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: DHCPv4 reservation route — list / create / delete.
...
Mounted on `/api/opnsense/dhcp`. Refuses writes when plugin
...
from opnsense_src.writers import AuditLog, DhcpReservationInput, DhcpReservationWriter
