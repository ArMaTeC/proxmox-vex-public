...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/native/opnsense/opnsense_src/routes/unbound.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: Unbound host-override route.
...
Mounted on `/api/opnsense/unbound`.
...
from opnsense_src.writers import (
    AuditLog,
    UnboundDomainInput,
    UnboundDomainWriter,
    UnboundDotInput,
