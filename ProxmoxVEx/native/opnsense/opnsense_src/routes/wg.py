...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/native/opnsense/opnsense_src/routes/wg.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: WireGuard peer (client) route.
...
from opnsense_src.writers import AuditLog, WireguardPeerInput, WireguardPeerWriter
