...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/native/opnsense/opnsense_src/writers/one_to_one.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: 1:1 NAT (BINAT) CRUD writer.
...
class OneToOneNatWriter:
    ...
    def create(self, payload: OneToOneNatInput) -> OneToOneResult:
        ...
        entry = self._record(
            "one_to_one.create", uuid, "ok", t, payload.description, payload_sha256=hash_payload(payload.to_payload())
        )
