...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/native/opnsense/opnsense_src/writers/rule.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: Firewall filter rule CRUD writer.
...
class RuleWriter:
    ...
    def create(self, payload: RuleInput) -> RuleResult:
        ...
        entry = self._record(
            "rule.create", uuid, "ok", t, payload.description, payload_sha256=hash_payload(payload.to_payload())
        )
