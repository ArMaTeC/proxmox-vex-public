...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/native/opnsense/opnsense_src/writers/nat.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: Outbound (source) NAT CRUD writer.
...
class NatWriter:
    ...
    def create(self, payload: NatInput) -> NatResult:
        ...
        entry = self._record(
            "nat.create", uuid, "ok", t, payload.description, payload_sha256=hash_payload(payload.to_payload())
        )
