...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/utils/audit.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: ProxmoxVEx Audit Logging - Layer 3
# Docs:        https://proxmoxvex.local/docs
# Generated:   2026-09-04
# --------------------------------------------------------------------
# --- ProxmoxVEx auto-header end ---
"""
ProxmoxVEx Audit Logging - Layer 3
"""
...
from ProxmoxVEx.utils.sanitization import sanitize_log_message
...
def cleanup_audit_log():
    ...
    Retention is now admin-configurable via settings
...
def log_audit(user: str, action: str, details: str = None, ip_address: str = None, cluster: str = None):
    ...
    # CWE-117. user / action / details / cluster all flow through
...
def _is_loopback(addr):
    ...
    Dual-stack sockets report IPv4 loopback as ::ffff:127.0.0.1
    """
...
# Trusted proxy list for non-loopback reverse proxies (nginx on different host)
...
def _is_trusted_proxy(addr):
    """Check if addr is loopback or in trusted_proxies list"""
...
def get_client_ip():
    ...
    Only trust X-Forwarded-For from trusted sources
    2026-04-24 - canonicalize to close the ::ffff:/IPv4 lockout-bucket split
    """
