...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/utils/vnc_polling.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: HTTP long-polling fallback for VNC when the WebSocket...
...
Added as the third defensive layer alongside Stable Mode and the
...
class VncPollSession:
    ...
    def __init__(
        self, poll_id: str, pve_ws, tunnel_endpoint, crypto_session, cluster_id: str, vm_type: str, vmid: int, host: str
    ):
