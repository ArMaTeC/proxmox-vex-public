...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/utils/ws_lenient.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: Lenient WebSocket opening-handshake helper for...
...
2. **Proxmox VE 9.1.8-9.1.9 hosts** running ProxmoxVEx co-located on the PVE
   node. The PVE-side traffic-handling stack started normalising Connection
   headers in a way that drops the `Upgrade` token. Reported as ProxmoxVEx
...
Driven by Issue #352, fix targeted at the actual symptom on PVE
