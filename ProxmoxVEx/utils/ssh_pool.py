...
# --------------------------------------------------------------------
# File:        ProxmoxVEx/utils/ssh_pool.py
# Project:     ProxmoxVEx
# Version:     1.2.303
# Build:       2026.09.04
# Description: ProxmoxVEx SSH Connection Pool & ControlMaster Helpers...
# Docs:        https://proxmoxvex.local/docs
# Generated:   2026-09-04
# --------------------------------------------------------------------
# --- ProxmoxVEx auto-header end ---
"""
ProxmoxVEx SSH Connection Pool & ControlMaster Helpers - Layer 4

Phase 2 SSH stabilization for big clusters (15+ nodes).
...
_CM_DIR_CANDIDATES = ["/run/ProxmoxVEx", "/var/run/ProxmoxVEx", f"{tempfile.gettempdir()}/ProxmoxVEx-cm"]
_cm_dir = None
...
def get_pooled_transport(host, port, user, password=None, pkey=None, pkey_data=None, connect_timeout=10):
