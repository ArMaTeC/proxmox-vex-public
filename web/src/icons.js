 ...
 * -------------------------------------------------------------------
 * File:        web/src/icons.js
 * Project:     ProxmoxVEx
 * Version:     1.2.303
 * Build:       2026.09.04
 * Description: Icons JS source
 * Docs:        https://proxmoxvex.local/docs
 * Generated:   2026-09-04
 * -------------------------------------------------------------------
 * --- ProxmoxVEx auto-header end --- */
const iconClass = (className, fallbackSize) => {
    if (className === undefined || className === null || className === '') return fallbackSize;
    return /(^|\s)[wh]-/.test(className) ? className : `${fallbackSize} ${className}`;
};
const Icons = {
    Server: () => (
    ...
    // New icons for alerts, tasks, tags, affinity
    Mail: () => (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    RotateCw: ({ className, style } = {}) => (
        <svg className={iconClass(className, 'w-4 h-4')} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
        </svg>
    ),
    Terminal: () => (
    ...
    // Unplug icon - plug with arrow showing disconnect
    Unplug: () => (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    // LifeBuoy icon for support bundle
    LifeBuoy: () => (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <circle cx="12" cy="12" r="10" strokeWidth={2} />
    ...
    // Box icon for containers/packages
    Box: ({ className, style }) => (
        <svg className={className || "w-5 h-5"} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
        </svg>
    ...
    // Needed for corporate VM detail back button
    ChevronLeft: (props) => (
        <svg className={props.className || "w-4 h-4"} style={props.style} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    Loader: ({ className, style } = {}) => (
        <svg className={iconClass(className, 'w-5 h-5')} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
        </svg>
    ),
    // Added missing icons for About section
    Heart: () => (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    // MessageSquare icon for discussions
    MessageSquare: () => (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
        </svg>
    ),
    // PBS File Browser icons
    ArrowLeft: () => (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    // Server icon for QEMU VMs in diagram view
    ...
    // Circle alert icon (used in PBS Gap-tab empty state)
    ...
    // OS-type icons for sidebar VM/CT display (Aug 2026)
    Windows: ({ className, style } = {}) => (
        <svg className={className || "w-4 h-4"} style={style} fill="currentColor" viewBox="0 0 24 24">
            <path d="M3 12.5l7-1V5.5l-7 1v6zm0 6.5l7-1v-6l-7 1v6zm8-13.5v6l10-1.5V3L11 5.5zm0 7v6L21 21v-7.5l-10 1z" />
        </svg>
    ),
    Linux: ({ className, style } = {}) => (
        <svg className={className || "w-4 h-4"} style={style} fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 2C9.5 2 8 4.5 8 7.5c0 1.5.4 2.8 1 3.8-.8.8-1.5 1.8-2 3-.8 2-1 3.7-1 4.7 0 1 .5 2 1.5 2s1.5-.3 2-1c.5.7 1 1 1.5 1h2c.5 0 1-.3 1.5-1 .5.7 1 1 2 1s1.5-1 1.5-2c0-1-.2-2.7-1-4.7-.5-1.2-1.2-2.2-2-3 .6-1 1-2.3 1-3.8C16 4.5 14.5 2 12 2zm-1.5 5a1 1 0 110 2 1 1 0 010-2zm3 0a1 1 0 110 2 1 1 0 010-2zm-1.5 3c.3 0 .7.2.7.5s-.3.5-.7.5-.7-.2-.7-.5.3-.5.7-.5z" />
        </svg>
    ),
    // VM with OS overlay — composite icon showing VM type + OS badge
    VmWindows: ({ className, style } = {}) => (
        <svg className={className || "w-4 h-4"} style={style} fill="none" viewBox="0 0 24 24">
            <rect x="2" y="3" width="20" height="14" rx="2" stroke="currentColor" strokeWidth={1.5} />
            <path stroke="currentColor" strokeLinecap="round" strokeWidth={1.5} d="M8 21h8M12 17v4" />
            <path fill="currentColor" d="M7 7l4-.5v3.5H7V7zm0 4h4v3.5l-4-.5V11zm5-4.5l5-.7V10h-5V6.5zm0 4.5h5v4.2l-5-.7V11z" opacity="0.85" />
        </svg>
    ),
    VmLinux: ({ className, style } = {}) => (
        <svg className={className || "w-4 h-4"} style={style} fill="none" viewBox="0 0 24 24">
            <rect x="2" y="3" width="20" height="14" rx="2" stroke="currentColor" strokeWidth={1.5} />
            <path stroke="currentColor" strokeLinecap="round" strokeWidth={1.5} d="M8 21h8M12 17v4" />
            <path fill="currentColor" d="M12 6c-1.2 0-2 1.2-2 2.8 0 .7.2 1.3.5 1.8-.4.4-.8.9-1 1.5-.4 1-.5 1.8-.5 2.4 0 .5.2 1 .7 1s.8-.2 1-.5c.2.3.5.5.8.5h1c.3 0 .5-.2.8-.5.2.3.5.5 1 .5s.7-.5.7-1c0-.6-.1-1.4-.5-2.4-.2-.6-.6-1.1-1-1.5.3-.5.5-1.1.5-1.8 0-1.6-.8-2.8-2-2.8zm-.7 2.5a.5.5 0 110 1 .5.5 0 010-1zm1.4 0a.5.5 0 110 1 .5.5 0 010-1z" opacity="0.85" />
        </svg>
    ),
    // Container (LXC) with OS overlay
    CtLinux: ({ className, style } = {}) => (
        <svg className={className || "w-4 h-4"} style={style} fill="none" viewBox="0 0 24 24">
            <path stroke="currentColor" strokeWidth={1.5} d="M7 4h10a2 2 0 012 2v12a2 2 0 01-2 2H7a2 2 0 01-2-2V6a2 2 0 012-2z" />
            <path stroke="currentColor" strokeLinecap="round" strokeWidth={1.2} d="M8 8h8M8 12h5" />
            <circle cx="17" cy="17" r="4.5" fill="currentColor" opacity="0.15" stroke="currentColor" strokeWidth={0.8} />
            <path fill="currentColor" d="M17 13.5c-.7 0-1.2.7-1.2 1.6 0 .4.1.8.3 1-.2.2-.5.5-.6.9-.2.5-.3 1-.3 1.3 0 .3.1.6.4.6s.5-.1.6-.3c.1.2.3.3.5.3h.6c.2 0 .3-.1.5-.3.1.2.3.3.6.3s.4-.3.4-.6c0-.3-.1-.8-.3-1.3-.1-.4-.4-.7-.6-.9.2-.2.3-.6.3-1 0-.9-.5-1.6-1.2-1.6z" opacity="0.85" />
        </svg>
    ),
};
